...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    List<Object[]> getCategoryTotalsByUserIdAndTypeAndDateBetween(@Param("userId") Long userId, @Param("type") TransactionType type, @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
}